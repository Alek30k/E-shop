...
const Skeleton = () => {
  return (
    <div className="col-span-1 cursor-pointer border-[1.2px] border-slate-200  bg-slate-50 rounded-sm p-2 transition hover:scale-105 text-center text-sm">
      ...
      <div className="h-3 w-[60%] m-auto bg-gray-300 rounded-full mb-3"></div>
      <div className="h-3 bg-gray-300 w-[50%] m-auto rounded-full mb-3"></div>
      <div className="h-3 bg-gray-300 w-[20%] m-auto rounded-full mb-3"></div>
    </div>
  );
};
