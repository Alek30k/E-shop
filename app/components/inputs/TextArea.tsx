  ...
  return (
    <div className="relative w-full">
      <textarea
        ...
        placeholder=""
        className={`peer w-full p-4 pt-6 max-h-[150px] min-h-[150px] dark:text-medium outline-none bg-white font-light border-2 rounded-md transition disabled:opacity-70 disabled:cursor-not-allowed 
